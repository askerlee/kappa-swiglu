...
while True:
    ...
    if step % args.log_interval == 0:
        ...
        for i in moe_layer_indices:
            ...
            if f'exp_gate_proj_bias_shift_abs_mean_{i}' in losses:
                log_data.update({f"inspect/exp_gate_proj_bias_shift_abs_mean_{i}": losses[f'exp_gate_proj_bias_shift_abs_mean_{i}']})
